...
pub const CONTINUITY_MANUFACTURER_ID: u16 = 0x004C; // Apple Inc.
...
impl TryFrom<Bytes> for ContinuityMessage {
    ...
    fn try_from(value: Bytes) -> Result<Self, Self::Error> {
        ...
        match ContinuityMessageDiscriminants::try_from(message_type)? {
            ...
            ContinuityMessageDiscriminants::ProximityPairing => Ok(ContinuityMessage::ProximityPairing(
                ProximityPairing::try_from(value)?,
            )),
